...
INSERT INTO Employee (NationalID, Name, Area, City)
VALUES
    (15, 'Christopher Wilson', 'Sales', 'New York'),
    (16, 'Amanda Roberts', 'Marketing', 'Los Angeles'),
    (17, 'Kevin Johnson', 'Finance', 'Chicago'),
    (18, 'Laura Thompson', 'Human Resources', 'San Francisco'),
    (19, 'Matthew Smith', 'Operations', 'Houston'),
    (20, 'Sophia Davis', 'IT', 'Seattle'),
    (21, 'Oliver Brown', 'Research and Development', 'Boston'),
    (22, 'Emma Wilson', 'Sales', 'New York'),
    (23, 'James Johnson', 'Marketing', 'Los Angeles'),
    (24, 'Grace Thompson', 'Finance', 'Chicago');
go
